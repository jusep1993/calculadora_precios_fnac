...
def app():
    ...
    # def is_member():
    #     if b_is_member:
    #         financin_yes_rbtn.config(bg="blue")
    #         financin_no_rbtn.config(state="normal")
    #
    #     if  b_is_member == False:
    #         financin_yes_rbtn.config(bg="#808080")
    ...
    b_is_member = tkinter.BooleanVar()
    b_want_financing = tkinter.BooleanVar()
    ...
    member_yes_rbtn = tkinter.Radiobutton(frame, text="Si", variable=b_is_member, value=True)
    member_no_rbtn = tkinter.Radiobutton(frame, text="No", variable=b_is_member, value=False)
    ...
    financin_yes_rbtn = tkinter.Radiobutton(frame, text="Si", variable=b_want_financing, value=True)
    financin_no_rbtn = tkinter.Radiobutton(frame, text="No", variable=b_want_financing, value=False)
